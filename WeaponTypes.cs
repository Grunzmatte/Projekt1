...
namespace Projekt1
{
    ...
    class WeaponType
    {
        ...
        static private Type Stein = new Type { typeName = "Stein", minDamage = 1, maxDamage = 3, minSpeed = 1, maxSpeed = 3, nameModifyer = "r" };
        static private Type Stock = new Type { typeName = "Stock", minDamage = 1, maxDamage = 2, minSpeed = 3, maxSpeed = 4, nameModifyer = "r" };
